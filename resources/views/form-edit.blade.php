...
@section('content')
    ...
    <form action="{{ route('movies.update', ['movie' => $movie->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="{{ asset('images/' . $movie->foto_sampul) }}" class="img-thumbnail" alt="{{ $movie->judul }} thumbnail" width="100px">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <a href="{{ route('movies.data') }}" class="btn btn-secondary">Kembali</a>
        </div>
    </form>
@endsection
